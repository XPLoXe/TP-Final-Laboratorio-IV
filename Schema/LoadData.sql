...
(9,'Lautaro & Asoc.',1997,'New York','Nuestros clientes en Lautaro & Asoc. Firm provienen de una diversidad de orígenes y ubicaciones. Todos los días se nos acercan con varios problemas, preguntas e inquietudes, pero cada cliente está buscando lo mismo: una defensa eficaz, sólida y ganadora de los cargos penales federales. Eso es exactamente lo que ofrecemos. El bufete de abogados Lautaro & Asoc. está adoptando un enfoque sin precedentes para la defensa criminal federal. Como equipo, nos hemos comprometido a desarrollar la mejor práctica de defensa federal en los Estados Unidos.','Lautaro.png','Lautaro&Asoc@firm.com','903 932 331'),
